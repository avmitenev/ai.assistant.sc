...
def create_full_chain(retriever, openai_api_key=None):
    ...
    Use the provided context from Standard Chartered bank's products and services to answer the user's questions. 
...
def main():
    ...
    try:
        ...
        queries = [ 
            "What are the benefits of opening an Standard Chartered Ordinary Account?",
            "What are the interest rates for a home loan at Standard Chartered Bank?",
            "Can you compare the Standard Chartered Gold Credit Card to the Classic Credit Card?",
            "How much does it cost to send money to an M-Pesa account using Standard Chartered Mobile Banking?",
        ]
